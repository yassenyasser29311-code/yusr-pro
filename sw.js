...
// (حدّثنا هنا رقم app.js لـ v=9 مع إضافة الجولة التعريفية، وظبطنا رقم
// styles.css اللي كان متأخر ومش متطابق مع اللي في index.html - v=5 هنا
// كانت مش نفس v=6 الفعلي، فكان ممكن يأثر على أول تحميل أوفلاين للكاش الاحتياطي.)
