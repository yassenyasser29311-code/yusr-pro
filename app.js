    ...
    const I18N = {
        ar: {
            ...
            "nav.section.legal":"قانوني","nav.terms":"شروط الاستخدام","nav.privacy":"سياسة الخصوصية","nav.section.ai":"الذكاء الاصطناعي","nav.videoMock":"محاكي مقابلة فيديو","nav.salary":"تقدير الراتب المتوقع","nav.progress":"متابعة التقدم","nav.match":"مطابقة CV مع الوظيفة","nav.cover":"مولّد رسائل توظيف","nav.closeMenu":"إغلاق القائمة","nav.clearSearch":"مسح البحث","nav.openMenu":"فتح القائمة","pwa.title":"نزّل يُسْر Pro كتطبيق","pwa.desc":"أيقونة على شاشتك الرئيسية، بيفتح زي أي تطبيق عادي","pwa.installBtn":"تثبيت التطبيق","pwa.hideAria":"إخفاء اقتراح التثبيت","hide":"إخفاء","apk.title":"جرّب تطبيقنا لأندرويد 📱","apk.desc":"أسرع وأسهل من المتصفح، وتحميله مباشر من هنا","apk.hideAria":"إخفاء اقتراح التطبيق","apk.downloadBtn":"نزّل تطبيق يُسْر Pro دلوقتي","trial.headerTitle":"المحاولات المجانية المتبقية الشهر ده","support.techLabel":"الدعم الفني",
...
,
        ...
        ur: {
            ...
            "nav.section.legal":"قانونی","nav.terms":"استعمال کی شرائط","nav.privacy":"رازداری کی پالیسی","nav.section.ai":"مصنوعی ذہانت","nav.videoMock":"ویڈیو مقابلہ سمیولیٹر","nav.salary":"متوقع تنخواہ کا تخمینہ","nav.progress":"پیش رفت کی نگرانی","nav.match":"سی وی اور ملازمت میچنگ","nav.cover":"ملازمت خط جنریٹر","nav.closeMenu":"مینو بند کریں","nav.clearSearch":"تلاش صاف کریں","nav.openMenu":"مینو کھولیں","pwa.title":"YUSR Pro کو ایپ کے طور پر ڈاؤن لوڈ کریں","pwa.desc":"آپ کی ہوم اسکرین پر ایک آئیکن، جو کسی بھی عام ایپ کی طرح کھلتا ہے","pwa.installBtn":"ایپ انسٹال کریں","pwa.hideAria":"انسٹال تجویز چھپائیں","hide":"چھپائیں","apk.title":"ہماری اینڈرائیڈ ایپ آزمائیں 📱","apk.desc":"براؤزر سے تیز اور آسان — اسے براہ راست یہاں سے ڈاؤن لوڈ کریں","apk.hideAria":"ایپ تجویز چھپائیں","apk.downloadBtn":"ابھی YUSR Pro ایپ ڈاؤن لوڈ کریں","trial.headerTitle":"اس مہینے باقی مفت کوششیں","support.techLabel":"تکنیکی معاونت",
